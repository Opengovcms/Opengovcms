...
class IEvents(IPortletDataProvider):
    """ """
...
class Assignment(collection.Assignment):
    """ """
    implements(collection.ICollection, IEvents)

    show_more_text = ""

    def __init__(self, **kwargs):
        self.show_more_text = kwargs['show_more_text']
        kwargs.pop('show_more_text')
...
class AddForm(collection.AddForm):
    ...
    fields = field.Fields(IEvents)

    label = _c(u"Add Events Portlet")
    description = _c(u"This portlet lists upcoming Events.")
...
class EditForm(collection.EditForm):
    ...
    label = _c(u"Edit Events Portlet")
    description = _c(u"This portlet lists upcoming Events.")
