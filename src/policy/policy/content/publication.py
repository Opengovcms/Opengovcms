...
class IPublication(form.Schema, IImageCropping):
    ...
    publication_cover_caption = schema.TextLine(
        ...
        description=_(
            u"help_publication_cover_caption",
    ...
    iisbn = schema.TextLine(
        ...
        description=_(
            u"help_internet_isbn",
            default=u"The Internet ISBN record identifier"
                    u"for this publication."
        ),
        required=False,
        constraint=validators.stdnum_validator('isbn'),
    )
    ...
    iissn = schema.TextLine(
        ...
        description=_(
            u"help_internet_issn",
            default=u"The Internet ISSN record identifier"
                    u"for this publication."
        ),
        required=False,
        constraint=validators.stdnum_validator('issn'),
    ...
    issuu_url = schema.Int(
        title=_(u"Issuu URL"),
        description=_(
            u"Add a link to Issuu version of the publication,"
            u"e.g http://www.issuu.com/myaccount/docs/mypublication."
        ),
        required=False
    )
