...
class Assignment(collection.Assignment):
    """ """
    implements(collection.ICollection, IPublications)
...
class AddForm(collection.AddForm):
    ...
    fields = field.Fields(IPublications)
    
    label = _c(u"Add Publications Portlet")
    description = _c(u"This portlet displays recent Publications.")
...
class EditForm(collection.EditForm):
    ...
    label = _c(u"Edit Publications Portlet")
    description = _c(u"This portlet displays recent Publications.")
